...
/*	// En el main solo llamás a las acciones:
	cargarArreglo(vectorDatos);
	mostrarArreglo(vectorDatos);
	mostrarInverso(vectorDatos);
	
	// El ordenamiento se hace por separado
	ordenarBurbujaDescendente(vectorDatos); 
	mostrarArreglo(vectorDatos); // Volvés a mostrar el vector para ver el cambio*/
